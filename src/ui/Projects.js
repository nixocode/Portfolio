...
export const knownProjects = [
  ...
  { name: 'RE-GROUND', title: 'RE:Ground', categoryBadge: 'Brand & Sustainability', techStack: ['HTML', 'CSS', 'JavaScript'], description: 'A circular beauty brand concept that upcycles coffee waste from partner cafés into premium, sustainable skincare products.', live_url: 'https://nixocode.github.io/RE-GROUND/' },
  { name: 'Class_Project_Sales_Plan', title: 'Sales Plan Playground', categoryBadge: 'Business & Strategy', techStack: ['HTML', 'CSS', 'JavaScript'], description: 'An interactive educational framework teaching a systematic 5-step approach to sales planning — from constraint analysis through market penetration strategy.', live_url: 'https://nixocode.github.io/Class_Project_Sales_Plan/' },
];
